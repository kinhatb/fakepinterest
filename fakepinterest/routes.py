...
def homepage():
    ...
    if formlogin.validate_on_submit():
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha, formlogin.senha.data).decode('utf8'):
...
def criarconta():
    ...
    if formcriarconta.validate_on_submit():
        senha = bcrypt.generate_password_hash(formcriarconta.senha.data).decode('utf8')
